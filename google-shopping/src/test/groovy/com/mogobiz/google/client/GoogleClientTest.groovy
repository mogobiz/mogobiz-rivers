...
class GoogleClientTest extends GroovyTestCase{
    ...
    public static final String ACCOUNT_ID = '1028899612234-hgq28mq5vuf6t27fo3q81ch4ne33beo2@developer.gserviceaccount.com'//'mogobiz@gmail.com'
    ...
    public void testRequestOAuth2AccessToken(){
        assertNotNull GoogleClient.instance.requestOAuth2AccessToken(buildClientConfig())
    }
